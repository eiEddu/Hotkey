...
from .views import ChaveListView, ChaveBlocoCreateView, ChaveQuartoCreateView, ChaveSalaComercialCreateView, \
    ChaveDeleteView, ChaveBlocoUpdateView, ChaveQuartoUpdateView, ChaveSalaComercialUpdateView
...
urlpatterns = [
    ...
    path('<int:pk>/editar/quarto/', ChaveQuartoUpdateView.as_view(), name='chave_quarto_editar'),
    path('<int:pk>/editar/sala-comercial/', ChaveSalaComercialUpdateView.as_view(), name='chave_sala_comercial_editar'),
